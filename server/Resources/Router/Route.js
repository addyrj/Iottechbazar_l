...
const { addProduct, getProduct, updateProduct, deleteProduct, changeProductStatus, getProductDetail, addSecondaryImages, addProductTitle, getProductTitle, createProductInfoMultiLanguage, getProductSection, addProductReview, getProductReview, getProductAdminReview, updateProductReview,deleteProductTitle ,editProductTitle} = require("../Controller/ProductController");
const { addRole, getRole, updateRole,deleteRole } = require("../Controller/RoleController");
...
router.post("/deleteRole", AdminAuth, uploadFiles.none(), deleteRole);
...
// edit product title
router.put("/editProductTitile", AdminAuth, uploadFiles.none(), editProductTitle);

// delete product title
router.delete("/deleteProductTitle", AdminAuth, uploadFiles.none(), deleteProductTitle);
